 ...
 */
return array(
	'title'	  => __( 'Header 1 - Default', 'avalon' ),
	...
	<div class="wp-block-group alignfull header-1" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:group {"style":{"spacing":{"padding":{"right":"30px","bottom":"16px","left":"30px","top":"10px"}}},"backgroundColor":"secondary","className":"avalon-banner","layout":{"type":"constrained"}} -->
