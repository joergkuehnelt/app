 ...
 */
return array(
	'title'	  => __( 'Header 3 - Sticky', 'avalon' ),
	...
	<div class="wp-block-group alignfull header header-1" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:group {"style":{"spacing":{"padding":{"right":"30px","bottom":"16px","left":"30px","top":"10px"}}},"backgroundColor":"secondary","className":"avalon-banner","layout":{"type":"constrained"}} -->
	<div class="wp-block-group avalon-banner has-secondary-background-color has-background" style="padding-top:10px;padding-right:30px;padding-bottom:16px;padding-left:30px"><!-- wp:paragraph {"align":"center","fontSize":"tiny"} -->
	...
	<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","right":"30px","left":"30px","bottom":"10px"},"margin":{"top":"0","bottom":"0"}}},"className":"socials-cart avalon-banner","layout":{"type":"constrained"}} -->
	<div class="wp-block-group socials-cart avalon-banner" style="margin-top:0;margin-bottom:0;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px"><!-- wp:columns {"align":"wide"} -->
	<div class="wp-block-columns alignwide"><!-- wp:column {"verticalAlignment":"center"} -->
	<div class="wp-block-column is-vertically-aligned-center"><!-- wp:social-links {"iconColor":"black","iconColorValue":"#000000","size":"has-small-icon-size","className":"is-style-logos-only socials","layout":{"type":"flex","justifyContent":"left"}} -->
